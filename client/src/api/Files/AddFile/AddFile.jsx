...
const AddFile = () => {
  ...
  const handleChange = (e) => {
    ...
    console.log("datos enviados " + addFile);
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "/api/newFile",
        form,
        console.log("Contenido form " + form),
        console.log("Contenido addFile " + addFile),
        { ...addFile },
        {
          headers: {
            Authorization: token,
      ...
      console.error(error); // Esto te ayudará a ver el error completo en la consola.
      setErrorMessage(
