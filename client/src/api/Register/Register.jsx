    ...
    return (
        <div className='register'>
            ...
            <div className="container">
                <div className="title text-center mt-3"><h1>REGISTRATE</h1></div>
                <form onSubmit={handleSubmit} className="col-12 g-3  mt-2">
                        ...
                        <div className="container buttons">
                            <div className=" row justify-content-around">
                                <div className="col-auto">
                                    <button className="btn btn-primary" type="submit" disabled={!userRegister.name.length || !userRegister.surname.length ||
